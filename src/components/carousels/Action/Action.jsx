...
export default function Action() {
  ...
  const { actionMovies, fetchActionMovies, loading, error } = useMovies();

  useEffect(() => {
    fetchActionMovies(); // Fetch trending movies on component mount
  }, [fetchActionMovies]); // Ensure fetchTrendingMovies is stable or memoized
