...
export default function Horror() {
  ...
  const { horrorMovies, fetchHorrorMovies, loading, error } = useMovies();

  useEffect(() => {
    fetchHorrorMovies(); // Fetch trending movies on component mount
  }, [fetchHorrorMovies]); // Ensure fetchTrendingMovies is stable or memoized
